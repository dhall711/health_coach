...
// Routes all queries through the Vercel-hosted /api/db endpoint
//
// Usage:
...
class TableBuilder {
  ...
  insert(data: Record<string, unknown> | Record<string, unknown>[]): Promise<QueryResult> {
  ...
  upsert(data: Record<string, unknown> | Record<string, unknown>[], options?: { onConflict?: string }): Promise<QueryResult> {
...
class FilterChain implements PromiseLike<QueryResult> {
  private desc: QueryDescriptor;
  constructor(desc: QueryDescriptor) { this.desc = desc; }
...
class UpdateChain implements PromiseLike<QueryResult> {
  private desc: QueryDescriptor;
  constructor(desc: QueryDescriptor) { this.desc = desc; this.desc.updateFilters = []; }
...
class DeleteChain implements PromiseLike<QueryResult> {
  private desc: QueryDescriptor;
  constructor(desc: QueryDescriptor) { this.desc = desc; this.desc.deleteFilters = this.desc.deleteFilters || []; }
