...
// Designed for minimal decision fatigue
...
// Pre-built meal templates optimized for:
// - ~1,800 cal/day target
// - 135g+ protein
// - Costco-friendly ingredients
// - Minimal prep time
...
export const LUNCH_TEMPLATES: MealTemplate[] = [
  {
    ...
    prep_notes: "Prep chicken in batches on Sunday",
    prep_time_min: 10,
  },
  {
    id: "l2",
    ...
    prep_notes: "Quick assembly, no cooking required",
    prep_time_min: 5,
  },
  {
    id: "l3",
    ...
    prep_notes: "Rice can be batch-prepped. Microwave broccoli 3 min.",
    prep_time_min: 8,
  },
  {
    id: "l4",
    name: "Protein Soup + Bread",
    meal_type: "lunch",
    calories: 460,
    protein_g: 35,
    carbs_g: 45,
    fat_g: 14,
    ingredients: [
      "2 cups chicken tortilla soup (Costco)",
      "1 slice Ezekiel bread",
      "1 string cheese",
    ],
    prep_notes: "Heat soup, toast bread. Done.",
    prep_time_min: 5,
  },
  {
    id: "l5",
    ...
    prep_notes: "Quick stovetop scramble, 8 min total",
    prep_time_min: 8,
  },
];
...
export const DINNER_TEMPLATES: MealTemplate[] = [
  {
    ...
    prep_notes: "Sheet pan: 400F for 20 min. Minimal cleanup.",
    prep_time_min: 25,
  },
  {
    id: "d2",
    ...
    fat_g: 18,
    ingredients: [
      "6 oz chicken thigh, sliced",
      "2 cups stir-fry vegetables",
      "1/2 cup brown rice",
      "2 tbsp low-sodium soy sauce",
    ],
    prep_notes: "Wok or large skillet, 15 min cook time",
    prep_time_min: 20,
  },
  {
    id: "d3",
    ...
    fat_g: 18,
    ingredients: [
      "5 turkey meatballs (Costco frozen)",
      "1 cup whole wheat pasta",
      "1/2 cup marinara sauce",
      "Side salad with vinaigrette",
    ],
    prep_notes: "Microwave meatballs, boil pasta. 12 min.",
    prep_time_min: 15,
  },
  {
    id: "d4",
    ...
    prep_notes: "Brown beef with taco seasoning. 10 min.",
    prep_time_min: 15,
  },
  {
    id: "d5",
    ...
    fat_g: 20,
    ingredients: [
      "6 oz Costco rotisserie chicken (no skin)",
      "1 cup roasted potatoes",
      "1 cup steamed green beans",
    ],
    prep_notes: "Zero prep if you grab a rotisserie chicken. Reheat sides.",
    prep_time_min: 5,
  },
];

/**
 * Generate a weekly meal plan with rotation.
...
export function generateWeeklyPlan(weekOffset: number = 0): DayPlan[] {
  ...
  return days.map((day, i) => {
    ...
    const total_calories = breakfast.calories + lunch.calories + dinner.calories;
    const total_protein_g = breakfast.protein_g + lunch.protein_g + dinner.protein_g;
...
/**
 * Generate grocery list from a weekly plan.
 */
